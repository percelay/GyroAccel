...
pd.read_csv("src/data/raw/MetaMotion/A-bench-heavy2-rpe8_MetaWear_2019-01-11T16.10.08.270_C42732BE255C_Accelerometer_12.500Hz_1.4.4.csv")

# all files in raw/MetaMotion
files = glob(
...
data_path = "/src/data/raw/MetaMotion/"
f = files[0]
...
data_resampled.to_pickle("src/data/interim/01_data_resampled.pkl")